...
const ChatFeatureComponent = () => {
    ...
    return(
          <div className="chat-features">
            <div className="feature-column">
              <MdOutlineWbSunny alt="Examples" className="feature-icon" />
              <h3>Examples</h3>
            ...
            <div className="feature-column">
              <BsLightning alt="Capabilities" className="feature-icon" />
              <h3>Capabilities</h3>
            ...
            <div className="feature-column">
              <IoWarningOutline alt="Limitations" className="feature-icon" />
              <h3>Limitations</h3>
  ...
  const gridFeatures = createGridFeatures();
